...
CI performs its existing browser setup before invoking `npm run verify`; it uses the CI-specific Chromium install command and does not install browsers through the root scripts.
