...
- [ ] **2. Rediseño visual card "Origen Verificado"**
  - Fondo con textura/efecto, barra lateral en vez de borde completo, icono con fondo circular, botón "Cambiar carta" en pill — según referencia visual de Kevin.
