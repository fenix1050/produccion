...
**Todos los ítems de Parte A verificados por Kevin y mergeados.** Próximo paso: pedirle a Análisis de Riesgo las tablas de RPF por cantidad de cuotas (0-11) para Incendio y Vida/AP (MRC ya las tiene en la Hoja4 del Excel) — bloqueante confirmado antes de arrancar el ciclo SDD de la Parte B (RPF variable por cuotas, ver sección 30 del roadmap y memoria Engram `project_mrc_ajustes_analisis_riesgo.md`).
