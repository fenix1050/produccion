...
const migrationUrl = new URL('./071_revoke_pf3_rpc_browser_roles.sql', import.meta.url)
...
test('migration 071 removes PF-3 RPC execution from browser roles while preserving service role access', async () => {
