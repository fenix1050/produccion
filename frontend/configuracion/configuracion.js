...
function guardarValoresForm() {
  ...
  if (!form) return
  state.form.password_actual =
    form.querySelector('#campo-actual')?.value ?? state.form.password_actual
  state.form.password_nueva = form.querySelector('#campo-nueva')?.value ?? state.form.password_nueva
  state.form.password_confirmar =
    form.querySelector('#campo-confirmar')?.value ?? state.form.password_confirmar
}
