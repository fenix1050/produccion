...
export async function requireAuth(req, res, next) {
  try {
    ...
    req.usuario = {
      ...
      puede_gestionar_textos_propuesta: usuario.puede_gestionar_textos_propuesta,
      puede_descargar_propuestas: usuario.puede_descargar_propuestas,
      puede_anular_propuestas: usuario.puede_anular_propuestas,
      matricula_agente: usuario.matricula_agente,
